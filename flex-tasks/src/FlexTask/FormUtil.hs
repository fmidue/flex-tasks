...
>>> let myOtherForm = formify (Nothing :: Maybe String) [[single "input2"]]
-}


{- |
Compose two forms sequentially.
The result contains all of the fields from both input forms.
...
This means composing such a form with a custom one will result in a line break between them.
