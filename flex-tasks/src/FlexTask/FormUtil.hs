...
>>> let myForm = formify @Int Nothing $ single $ required $ basic "input"
>>> let myOtherForm = formify @String Nothing $ single $ required $ basic "input2"
...
>>> printWidget "en" $ formify @Int Nothing $ single $ required $ basic "Number Please"
<div class="flex-form-div form-group">
